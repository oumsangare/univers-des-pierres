...
SECRET_KEY = 'django-insecure-h_!@eap=&pg#o98#77_-7h4)j#p&o)-i2_j!5$85z)ti$9epw+'
...
ALLOWED_HOSTS = [
     "127.0.0.1",
    "localhost",
    "10.251.6.86",   # Remplace par ton adresse IP
]
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'boutique.context_processors.favorites_count',
            ],
        },
    },
]
